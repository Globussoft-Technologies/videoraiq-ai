...
import { SquarePen, TriangleAlert, Trash2, Eye } from 'lucide-react';
...
const STYLES = {
  ...
  CARD_CONTAINER: 'rounded-xl pb-6 px-6 pt-8 bg-white shadow-lg border border-gray-100 max-w-2xl md:pb-8 md:px-8 md:pt-10 2xl:rounded-2xl 2xl:pb-10 2xl:px-10 2xl:pt-12',
  ...
  GRID_CONTAINER: 'grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 2xl:gap-10',
  ERROR_BADGE:
...
const NvrLocalsettings = ({ nvrDetails, fetchNvrData, onDeleteNvr }) => {
        ...
        {Array.isArray(nvrDetails) && nvrDetails.length > 0 ? (
          nvrDetails.map((nvr, index) => (
            <div key={nvr._id || index} className={STYLES.CARD_CONTAINER}>
              ...
              <div className="flex justify-between items-start border-b border-gray-200 pb-4 mb-6 flex-wrap gap-3 md:pb-5 md:mb-8 md:gap-3 2xl:pb-6 2xl:mb-10 2xl:gap-6">
              ...
              <div className={STYLES.GRID_CONTAINER}>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={nvr.location || ''}
                    className={`${STYLES.INPUT_CONTAINER} border-1 bg-gray-50`}
                    disabled
                  />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className={`${STYLES.INPUT_CONTAINER} flex-1 border-1 bg-gray-50`}
                      disabled
                    />
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          onClick={() => handleCameraSettings(nvr?._id)}
                          className="cursor-pointer p-1.5 bg-[#074864] rounded-full"
                        >
                         <GoGear className="w-5 h-5 text-white" />
                        </button>
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Camera Settings</p>
...
export default NvrLocalsettings;
