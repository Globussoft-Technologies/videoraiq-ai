...
vi.mock("../../core/v1/incidents/incidents.controller.js", () => ({
  default: {
    ...
    getFireSmokeDetectionLogs: vi.fn(async (req, res) => res.status(200).json({ success: true, data: [] })),
    getPersonFallSickDetectionLogs: vi.fn(async (req, res) => res.status(200).json({ success: true, data: [] })),
    getCarModelDetectionLogs: vi.fn(async (req, res) => res.status(200).json({ success: true, data: [] })),
    getGuardSleepingLogs: vi.fn(async (req, res) => res.status(200).json({ success: true, data: [] })),
    ...
    deleteLineCrossingLogs: vi.fn(async (req, res) => res.status(200).json({ success: true })),
