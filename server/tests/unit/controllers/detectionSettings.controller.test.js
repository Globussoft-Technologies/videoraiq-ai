...
vi.mock(
  ...
  () => ({
    default: {
      ...
      getDetectionSchedule: vi.fn(),
      getCameraDetectionSchedule: vi.fn(),
      updateCameraDetectionSchedule: vi.fn(),
      resetCameraDetectionSchedule: vi.fn(),
...
const ALL_METHODS = [
  ...
  "getDetectionSchedule",
  "getCameraDetectionSchedule",
  "updateCameraDetectionSchedule",
  "resetCameraDetectionSchedule",
