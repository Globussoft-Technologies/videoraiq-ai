...
vi.mock("../../../mailService/mail.helper.js", () => ({
  default: {
    ...
    carModelDetection: vi.fn().mockResolvedValue("sent"),
...
describe("triggerAlertOnIncident", () => {
  ...
  it("dispatches the right template for each detectionType branch", async () => {
    ...
    const cases = [
      ...
      ["carModelDetection", "carModelDetection"],
      ...
      ["fireSmokeDetection", "fireSmokeDetection"],
      ["personFallSickDetection", "personFallSickDetection"],
