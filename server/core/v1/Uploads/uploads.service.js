...
import { streamMediaV2 } from "../../v2/adminStorage/mediaStorage.v2.js";
...
class UploadService {
    ...
    async fetchMedia(req, res) {
        try {
            ...
            // Keep the public /api/v1/uploads URLs backward-compatible while
            // allowing them to serve the per-admin `v2/...` keys generated by
            // auto-email reports. streamMediaV2 delegates legacy paths to the
            // original reader, so existing image/video links keep working.
