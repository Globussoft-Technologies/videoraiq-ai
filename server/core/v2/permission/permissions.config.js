...
export let completeConfig = {
    ...
    storageSettings: { view: false, create: false, edit: false, delete: false },
    ...
    logs: {
        ...
        cylinderLogs: { view: false, create: false, edit: false, delete: false },
...
export let adminConfig = {
    ...
    storageSettings: { view: true, create: true, edit: true, delete: true },
    ...
    logs: {
        ...
        cylinderLogs: { view: true, create: true, edit: true, delete: true },
...
export let readConfig = {
    ...
    storageSettings: { view: true, create: false, edit: false, delete: false },
    ...
    logs: {
        ...
        cylinderLogs: { view: true, create: false, edit: false, delete: false },
...
export let writeConfig = {
    ...
    storageSettings: { view: true, create: true, edit: true, delete: false },
    ...
    logs: {
        ...
        cylinderLogs: { view: true, create: true, edit: true, delete: false },
