...
const modelMap = {
  ...
  personFallSickDetectionSettings: PersonFallSickDetectionSetting,
  ...
  guardSleepingDetectionSettings: GuardSleepingDetectionSetting,
  conveyorDetectionSettings: ConveyorDetectionSetting,
  crusherDetectionSettings: CrusherDetectionSetting,
  cylinderDetectionSettings: CylinderDetectionSetting,
  ...
  equipmentOilLeakageDetectionSettings: EquipmentOilLeakageDetectionSetting,
  vehicleFuelOilLeakageDetectionSettings: VehicleFuelOilLeakageDetectionSetting,
...
class DetectionSettingService {
  ...
  async deleteDetectionSettings(req, res, _next) {
    try {
      ...
      // A DetectionSetting can be shared by multiple cameras. Stop it only on
      // the requested camera; legacy callers without channelId still select
      // every linked camera below.
      ...
      // behavior. client_v2 always supplies channelId for camera resets.
