...
const DETECTION_SEARCH_INDEX = [
  {
    kind: 'Detection',
    kindColor: '#f59e0b',
    label: 'Working at Height Detection',
    sub: 'Industrial & Environment • Work-at-height safety monitoring',
    keywords: 'working height elevated work safety industrial',
    to: '/detection-settings?detection=workingAtHeightDetectionSettings',
  },
  {
    kind: 'Detection',
    kindColor: '#06b6d4',
    label: 'Oil Leakage Detection',
    sub: 'Industrial & Environment • Oil leak monitoring',
    keywords: 'oil leakage leak spill hazard industrial',
    to: '/detection-settings?detection=oilLeakageDetectionSettings',
  },
  {
    kind: 'Detection',
    kindColor: '#8b5cf6',
    label: 'Gunny Bags/Materials Wrong Location Detection',
    sub: 'Industrial & Environment • Material placement monitoring',
    keywords: 'gunny bags materials wrong location misplaced',
    to: '/detection-settings?detection=gunnyBagsMaterialsWrongLocationDetectionSettings',
  },
  {
    kind: 'Detection',
    kindColor: '#78716c',
    label: 'Sand, Dust, Waste & Scrap Disposal Detection',
    sub: 'Industrial & Environment • Disposal monitoring',
    keywords: 'sand dust waste scrap disposal industrial',
    to: '/detection-settings?detection=sandDustWasteScrapDisposalDetectionSettings',
  },
  {
    kind: 'Detection',
    kindColor: '#ef4444',
    label: 'Unauthorized Animal Entry Detection',
    sub: 'Industrial & Environment • Animal intrusion monitoring',
    keywords: 'unauthorized animal entry intrusion',
    to: '/detection-settings?detection=unauthorizedAnimalEntryDetectionSettings',
  },
  {
    kind: 'Detection',
    kindColor: '#14b8a6',
    label: 'Spills, Dirty or Messy Areas Detection',
    sub: 'Industrial & Environment • Housekeeping monitoring',
    keywords: 'spills dirty messy areas housekeeping',
    to: '/detection-settings?detection=spillsDirtyMessyAreasDetectionSettings',
  },
  {
    kind: 'Detection',
    kindColor: '#ff5b57',
