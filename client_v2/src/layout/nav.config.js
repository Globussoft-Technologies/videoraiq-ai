...
const stevinrockLogItems = [
  ...
  { key: 'cylinder', label: 'Cylinder Stacking Logs', path: 'logs/cylinder', icon: Database , permissionKey: 'logs', permissionSubKey: 'cylinderLogs', logsConfigKey: 'cylinderLogs' },
  ...
  { key: 'equipment-oil-leakage', label: 'Equipment Oil Leakage Logs', path: 'logs/equipment-oil-leakage', icon: Droplet, permissionKey: 'logs', permissionSubKey: 'equipmentOilLeakageLogs', logsConfigKey: 'equipmentOilLeakageLogs' },
  { key: 'vehicle-fuel-oil-leakage', label: 'Vehicle Fuel/Oil Leakage Logs', path: 'logs/vehicle-fuel-oil-leakage', icon: Droplets, permissionKey: 'logs', permissionSubKey: 'vehicleFuelOilLeakageLogs', logsConfigKey: 'vehicleFuelOilLeakageLogs' },
...
export const VIEW_META = {
  ...
  'equipment-oil-leakage': { title: 'Equipment Oil Leakage Logs', sub: 'Oil leakage detected from equipment' },
  'vehicle-fuel-oil-leakage': { title: 'Vehicle Fuel/Oil Leakage Logs', sub: 'Fuel or oil leakage detected from vehicles' },
