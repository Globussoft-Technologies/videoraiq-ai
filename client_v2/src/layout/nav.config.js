...
const stevinrockLogItems = [
  ...
  { key: 'cylinder', label: 'Cylinder Stacking Logs', path: 'logs/cylinder', icon: PackageOpen, permissionKey: 'logs', permissionSubKey: 'cylinderLogs', logsConfigKey: 'cylinderLogs' },
