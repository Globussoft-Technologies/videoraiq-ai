...
const ENGINE_LABELS = {
  ...
  unauthorizedParkingDetectionSettings: 'PARK',
  ...
  equipmentOilLeakageDetectionSettings: 'EQ-OIL',
  vehicleFuelOilLeakageDetectionSettings: 'VEH-OIL',
