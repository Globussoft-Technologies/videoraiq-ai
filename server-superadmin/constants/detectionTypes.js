...
export const DETECTION_DESCRIPTIONS = {
  ...
  countVehiclesSettings: "Vehicle counting across lanes",
  conveyorDetectionSettings: "Conveyor belt activity & jam detection",
  crusherDetectionSettings: "Crusher operation & blockage monitoring",
  waterSpillageDetectionSettings: "Floor water & liquid spill detection",
  doorDetectionSettings: "Door open/closed state monitoring",
  lightDetectionSettings: "Light on/off state monitoring",
  vehicleObstructionSettings: "Vehicle blocking & obstruction alerts",
  deskAbsenceSettings: "Desk occupancy & absence tracking",
  guardAbsenceSettings: "Guard post absence monitoring",
  countPersonsSettings: "People counting across zones",
  motionDetectionSettings: "Basic motion & movement alerts",
  genericObjectDetectionSettings: "Custom object presence detection",
  loiteringWithoutAuthSettings: "Unauthorized dwell-time detection",
  loiteringWithAuthSettings: "Authorized-user dwell-time tracking",
  fireSmokeDetectionSettings: "Early fire & smoke detection",
  weaponDetectionSettings: "Weapon presence & threat alerts",
  unattendedBaggageDetectionSettings: "Unattended baggage & items",
  vehicleTypeDetectionSettings: "Vehicle classification by type",
  loiteringDetectionSettings: "Dwell-time & suspicious lingering",
