...
router.patch("/bulk/logout", sessionsController.bulkLogoutSessions);
router.patch("/bulk/block", sessionsController.bulkBlockSessions);
router.patch("/bulk/unblock", sessionsController.bulkUnblockSessions);
