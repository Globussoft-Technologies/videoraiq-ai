          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; background-color:#ffffff; border-radius:10px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
            ...
            <tr>
              <td style="padding:0 30px 20px 30px; color:#444444; font-size:15px; line-height:1.6; text-align:center;">
                ...
                <p style="margin:0;">We received a request to reset your password. Use the OTP below to set up a new one. If you didn’t request this, you can safely ignore this email.</p>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding:20px 0;">
                <span style="display:inline-block; padding:12px 28px; background-color:#f0f6fa; color:#07486A;
                  font-size:32px; letter-spacing:8px; border-radius:10px; font-weight:600;">
                  ${otp}
                </span>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding:0 30px 20px 30px; color:#7a7a7a; font-size:13px; line-height:1.4;">
                <p style="margin:0;">This OTP will expire in <strong>10 minutes</strong> for your security.</p>
              </td>
            </tr>
