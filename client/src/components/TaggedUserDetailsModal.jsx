...
import { UserDetailModal } from '@/helpers/Userregister/UserDetailModal';
 ...
 * spinner.
 *
 * Rendering is delegated to the Register User page's own details card, so a
 * tagged user reads exactly the same here as it does there.
 *
 * @param {object} taggedUser the trimmed record from the log row
 */
const TaggedUserDetailsModal = ({ open, taggedUser, onClose }) => {
...
export default TaggedUserDetailsModal;
