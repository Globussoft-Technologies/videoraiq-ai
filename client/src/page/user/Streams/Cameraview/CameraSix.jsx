...
const CameraSix = ({ cameraData = [],selectedVideo }) => {
  // Only use the first 6 cameras for this grid
  const cameras = cameraData.slice(0, 6);
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2  lg:h-[calc(100vh-102px)] ">
